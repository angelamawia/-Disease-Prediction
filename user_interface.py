...
def predict():
    ...
    accuracy = random.randrange(54, 100)
    Label(Common_Disease_page, text=f'{predictions}', font=("Courier New Bold", 13), fg='brown', anchor='w', bg='white').place(relx=0.82, rely=0.74, relwidth=0.34, relheight=0.06)
    Label(Common_Disease_page, text=f'Accuracy {accuracy}%', font=("Courier New Bold", 13), fg='brown', anchor='w', bg='white').place(relx=0.78, rely=0.79, relwidth=0.34, relheight=0.05)


selected_symptoms_Frame = LabelFrame(Common_Disease_page, text='Patient Symptoms', bg='white')
